...
public class NumericFingerprintGeneratorTest extends TestCase {
  ...
  public void testVectors() throws Exception {
    ...
    assertEquals(DISPLAYABLE_FINGERPRINT, aliceFingerprint.getDisplayableFingerprint().getDisplayText());
    assertEquals(DISPLAYABLE_FINGERPRINT, bobFingerprint.getDisplayableFingerprint().getDisplayText());

    assertArrayEquals(ALICE_SCANNABLE_FINGERPRINT, aliceFingerprint.getScannableFingerprint().getSerialized());
    assertArrayEquals(BOB_SCANNABLE_FINGERPRINT, bobFingerprint.getScannableFingerprint().getSerialized());
  }
  ...
  public void testMatchingFingerprints() throws FingerprintVersionMismatchException, FingerprintParsingException {
    ...
    assertEquals(60, aliceFingerprint.getDisplayableFingerprint().getDisplayText().length());
  }
