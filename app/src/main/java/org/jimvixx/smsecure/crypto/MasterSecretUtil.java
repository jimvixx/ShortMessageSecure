          ...
          throws InvalidPassphraseException
  {
    try {
      ...
      if (encryptedAndMacdMasterSecret == null) {
        throw new InvalidPassphraseException("Missing master_secret");
      }

      byte[] macSalt = retrieve(context, "mac_salt");
      if (macSalt == null) {
        throw new InvalidPassphraseException("Missing mac_salt");
      }
      ...
      if (encryptionSalt == null) {
        throw new InvalidPassphraseException("Missing encryption_salt");
      }
      ...
      Log.w(TAG, "Failed to derive MasterSecret", e);
