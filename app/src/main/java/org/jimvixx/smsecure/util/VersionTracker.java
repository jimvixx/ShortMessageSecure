...
public class VersionTracker {
  ...
  public static boolean isDbUpdated(Context context) {
    try {
      ...
      return SMSecurePreferences.getLastVersionCode(context) >= packageInfo.versionCode;
    } catch (Exception e) {
      Log.w(TAG, e);
      return true;
    }
