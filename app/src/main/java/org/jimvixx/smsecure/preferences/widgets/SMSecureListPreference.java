...
/**
 * A ListPreference with a custom full layout and right-side selected entry.
 */
public class SMSecureListPreference extends ListPreference {

  private final RightSummaryConfig rightSummaryConfig;
  private TextView rightSummaryView;

  public SMSecureListPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    super(context, attrs, defStyleAttr, defStyleRes);
    rightSummaryConfig = initialize(context, attrs);
  }

  public SMSecureListPreference(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    rightSummaryConfig = initialize(context, attrs);
  }

  public SMSecureListPreference(Context context, AttributeSet attrs) {
    super(context, attrs);
    rightSummaryConfig = initialize(context, attrs);
  }

  public SMSecureListPreference(Context context) {
    super(context);
