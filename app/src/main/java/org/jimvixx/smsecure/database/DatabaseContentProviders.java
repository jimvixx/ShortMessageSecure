...
public class DatabaseContentProviders {
  ...
  public static class ConversationList extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://org.jimvixx.smsecure.database.conversationlist");
  }

  public static class Conversation extends NoopContentProvider {
    private static final String CONTENT_URI_STRING = "content://org.jimvixx.smsecure.database.conversation/";
  ...
  public static class Attachment extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://org.jimvixx.smsecure.database.attachment");
  }

  public static class Identities extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://org.jimvixx.smsecure.database.identities");
  }

  public static class RecipientPreference extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://org.jimvixx.smsecure.database.recipients/");
  }
