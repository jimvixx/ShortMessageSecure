...
public abstract class DisplayRecord {
  ...
  public boolean isPending() {
    return MessageColumns.Types.isPendingMessageType(type);
  }

  public boolean isOutgoing() {
    return MessageColumns.Types.isOutgoingMessageType(type);
  }

  public boolean isDuplicateMessageType() {
    return MessageColumns.Types.isDuplicateMessageType(type);
  }
