...
public class SmsMessageRecord extends MessageRecord {
  ...
  public SpannableString getDisplayBody() {
    if (SmsDatabase.Types.isFailedDecryptType(type)) {
      ...
      return emphasisAdded(context.getString(R.string.ConversationItem_xmpp_address_update_smsecure));
    } else if (isLegacyMessage() && isKeyExchange() && !isProcessedKeyExchange()) {
      return emphasisAdded(context.getString(R.string.MessageRecord_the_exchange_message_you_got_came_from_a_version_of_smsecure_that_is_too_outdated));
    } else if (isLegacyMessage() && isKeyExchange() && isProcessedKeyExchange()) {
      return emphasisAdded(context.getString(R.string.MessageRecord_key_exchange_message));
    } else if (MessageColumns.Types.isLegacyType(type)) {
