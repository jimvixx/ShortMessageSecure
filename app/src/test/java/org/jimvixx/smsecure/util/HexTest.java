...
public class HexTest {
  ...
  private final byte[] testBytes = new byte[16];
  ...
  @Test
  public void testFromStringCondensed() throws IOException {
    assertEquals(
  ...
  @Test
  public void testBytesDump() {
    String hexOfTestBytes =
